...
use proto::ds_alert_send_status::{
    ds_alert_send_status_service_server::DsAlertSendStatusService,
    CreateDsAlertSendStatusRequest,
    DeleteDsAlertSendStatusRequest,
    GetDsAlertSendStatusRequest,
    ListDsAlertSendStatusRequest,
...
#[tonic::async_trait]
impl DsAlertSendStatusService for DolphinRpcServer {
